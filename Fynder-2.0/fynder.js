...
function _getSmartReply(userText, cat, bizName, biz) {
  ...
  if (/\b(precio|costo|cuánto|cuanto|tarifa|valor|cobran|cobra|rate|presupuesto)\b/.test(t)) {
    const catPrices = {
      restaurantes: [
        'Nuestros platos van desde $5 hasta $25 dependiendo de la selección. ¿Te gustaría ver el menú completo? 🍽️',
        'Tenemos opciones para todos los presupuestos. El plato del día está a $8. ¿Algo en especial que busques?',
        'Los precios varían según el plato. ¿Quieres que te enviemos la carta con precios actualizada?'
      ],
      belleza: [
        'Los cortes desde $15, tintes desde $40 y tratamientos desde $30. ¿Qué servicio te interesa? 💇',
        'Tenemos paquetes muy accesibles. El servicio básico inicia en $12. ¿Quieres una cotización personalizada?',
        'Depende del servicio. ¿Corte, color, manicure o tratamiento? Te doy el precio exacto 💅'
      ],
      salud: [
        'La consulta general está en $40. Especialistas desde $60. ¿Qué tipo de atención necesitas? 🏥',
        'Trabajamos con varias aseguradoras. ¿Tienes seguro médico? Así te damos el precio real.',
        'Los precios varían según el especialista. ¿Nos dices qué tipo de consulta necesitas? 🩺'
      ],
      tecnologia: [
        'El diagnóstico es gratuito 🔧. Las reparaciones desde $20 dependiendo del daño. ¿Qué equipo tienes?',
        'Depende del servicio. ¿Reparación de pantalla, batería, software o algo diferente?',
        'Te damos presupuesto sin compromiso. ¿Cuál es el problema con tu equipo? 💻'
      ],
      hogar: [
        'Las visitas de diagnóstico son sin costo. Los trabajos desde $30. ¿Qué necesitas reparar? 🔨',
        'El presupuesto es gratuito y sin obligación. ¿Nos describes qué trabajo necesitas?',
        'Los precios dependen del trabajo. Dinos qué necesitas y te cotizamos al momento 🏠'
      ],
      turismo: [
        'Los tours inician desde $35 por persona. Grupos tienen descuento especial 🗺️. ¿Para cuántas personas?',
        'Tenemos paquetes desde $50 incluyendo transporte y guía. ¿Qué destino te interesa?',
        '¡Buena pregunta! Los precios varían según el tour. ¿Qué fecha tienes en mente? ✈️'
      ],
      transporte: [
        'Las tarifas dependen del destino. ¿Nos dices el punto de partida y llegada? 🚗',
        'Tenemos tarifas planas para rutas frecuentes. ¿A dónde necesitas ir?',
        'El precio varía según la distancia y tipo de vehículo. ¿Nos das más detalles? 🚕'
      ]
    };
    const prices = catPrices[cat] || [
      'Los precios varían según el servicio. ¿Puedes darnos más detalles de lo que buscas?',
      'Con gusto te damos una cotización. ¿Qué servicio o producto te interesa?',
      'Tenemos opciones para todos los presupuestos 💰. ¿Qué necesitas exactamente?'
    ];
    return _pick(prices);
  }

  // ── Horarios ──
  if (/\b(horario|hora|abren|cierran|aberto|abierto|disponible|atención|atienden|cuando)\b/.test(t)) {
    const hours = biz && biz.hours ? biz.hours : 'Lun–Sáb 8:00am – 6:00pm';
    return _pick([
      `Nuestro horario es ${hours} ⏰. ¿Hay algún día específico que te convenga más?`,
      `Atendemos ${hours}. Para citas o reservas puedes escribirnos con anticipación 📅`,
      `Estamos disponibles ${hours}. Los domingos bajo cita previa. ¿Necesitas una? 🗓️`
    ]);
  }

  // ── Dirección / ubicación ──
  if (/\b(dirección|ubicación|donde|dónde|están|estás|local|mapa|cómo llegar|como llegar|lugar)\b/.test(t)) {
    const addr = biz && biz.address ? biz.address : 'nuestra dirección en el perfil';
    return _pick([
      `Estamos en ${addr} 📍. ¿Necesitas que te enviemos la ubicación en Google Maps?`,
      `Nos encontramos en ${addr}. ¡Es muy fácil llegar! ¿Vienes en carro o transporte público? 🗺️`,
      `Nuestra dirección es ${addr}. Si quieres, te enviamos cómo llegar paso a paso 📌`
    ]);
  }

  // ── Cita / reserva / turno ──
  if (/\b(cita|reserva|reservar|agendar|turno|appointment|disponibilidad|cupo)\b/.test(t)) {
    return _pick([
      '¡Claro que sí! Para agendar tu cita necesito saber: ¿qué fecha y hora te viene bien? 📅',
      'Con mucho gusto agendamos. ¿Para cuántas personas y qué día prefieres? 🗓️',
      'Tenemos disponibilidad esta semana. ¿Mañana o pasado mañana te funciona? ⏰',
      '¡Perfecto! ¿Tienes preferencia de horario: mañana, tarde o noche? 📆',
      'Para la cita necesito tu nombre y el servicio que deseas. ¿Me los confirmas? ✅'
    ]);
  }

  // ── Menú / carta / productos ──
  if (/\b(menú|menu|carta|platos|platillos|productos|servicios|qué venden|qué ofrecen|que tienen)\b/.test(t)) {
    const catMenu = {
      restaurantes: [
        'Tenemos entradas, platos fuertes y postres 🍽️. ¿Quieres que te describa las especialidades del día?',
        '¡Nuestro menú es variado! Desde opciones vegetarianas hasta cortes a la parrilla. ¿Qué prefieres?',
        'El menú del día incluye sopa, plato principal y bebida a $10 🥗. ¿O prefieres algo à la carte?'
      ],
      belleza: [
        'Ofrecemos: cortes, tintes, tratamientos capilares, manicure, pedicure y maquillaje 💅. ¿Qué te interesa?',
        'Tenemos servicios completos de peluquería y estética. ¿Para dama o caballero?',
        '¡Hacemos de todo! Desde un corte básico hasta una transformación completa ✨. ¿Qué buscas?'
      ],
      tecnologia: [
        'Reparamos pantallas, baterías, cámaras, teclados y problemas de software 🔧. ¿Qué equipo tienes?',
        'Trabajamos con celulares, laptops, tablets y computadoras de escritorio 💻. ¿Cuál es tu caso?',
        'También vendemos accesorios y hacemos mantenimiento preventivo. ¿Qué necesitas? ⚙️'
      ]
    };
    const menu = catMenu[cat] || [
      `En ${bizName} ofrecemos una amplia variedad de productos y servicios. ¿Qué estás buscando específicamente?`,
      '¡Tenemos mucho para ofrecerte! ¿Nos cuentas qué necesitas y te orientamos? 😊',
      'Nuestro catálogo es bastante completo. ¿Tienes alguna necesidad particular en mente?'
    ];
    return _pick(menu);
  }

  // ── Delivery / envío / domicilio ──
  if (/\b(delivery|domicilio|envío|envio|mandan|despachan|llevan|traen|a mi casa|piden)\b/.test(t)) {
    return _pick([
      '¡Sí hacemos entregas a domicilio! 🛵 El tiempo estimado es de 30–45 minutos. ¿Cuál es tu dirección?',
      'Tenemos servicio de entrega dentro de la ciudad 📦. ¿Nos das tu ubicación?',
      'Delivery disponible de Lun–Dom. Envío gratis en compras mayores a $20 🎉. ¿Hacemos tu pedido?',
      'Sí enviamos a domicilio. ¿Dónde estás ubicado para verificar la cobertura? 📍'
    ]);
  }

  // ── Pagos / métodos de pago ──
  if (/\b(pago|pagar|efectivo|tarjeta|transferencia|yappy|nequi|sinpe|visa|mastercard|crédito|débito)\b/.test(t)) {
    return _pick([
      'Aceptamos efectivo, tarjetas de crédito/débito y transferencias bancarias 💳. ¿Con cuál pagas?',
      'Recibimos Visa, Mastercard, efectivo y pagos por Yappy 📱. ¡El método que prefieras!',
      'Todos los métodos de pago son bienvenidos: efectivo, tarjeta y transferencia ✅',
      'Aceptamos tarjeta, efectivo y pagos digitales. ¿Necesitas factura? 🧾'
    ]);
  }

  // ── Descuentos / promociones / ofertas ──
  if (/\b(descuento|promoción|promo|oferta|rebaja|especial|cupón|2x1|gratis)\b/.test(t)) {
    return _pick([
      '¡Sí tenemos promos! 🎉 Esta semana 20% de descuento en todos los servicios. ¿Te interesa?',
      'Los nuevos clientes tienen 15% de descuento en su primera compra 🌟. ¿Es tu primera vez con nosotros?',
      'Tenemos paquete especial: 2 servicios por el precio de 1 todos los martes 🔥. ¿Vienes?',
      'Los clientes frecuentes acumulan puntos para canjear. ¿Quieres saber más? ⭐'
    ]);
  }

  // ── Tiempo de espera / cuánto tarda ──
  if (/\b(cuánto tarda|cuanto tarda|tiempo|espera|demora|rápido|urgente|hoy mismo|mismo día)\b/.test(t)) {
    const catTime = {
      tecnologia: [
        'Reparaciones básicas en el mismo día ⚡. Las más complejas en 24–48 horas. ¿Qué tiene tu equipo?',
        'El tiempo depende del daño. Cambios de pantalla: 2 horas. Software: mismo día 🔧'
      ],
      restaurantes: [
        'Los pedidos en local: 15–20 min ⏱️. Delivery: 30–45 min. ¿Para cuándo lo necesitas?',
        'En restaurante lo sirves en mesa en 20 minutos. ¿Quieres reservar mesa? 🍽️'
      ],
      belleza: [
        'Un corte tarda 30 min, tinte 2 horas, manicure 1 hora 💅. ¿Qué servicio te interesa?',
        'Depende del servicio. Para no esperar, ¿agendamos una cita? 📅'
      ],
      hogar: [
        'Trabajos pequeños: mismo día ⚡. Proyectos grandes: 2–5 días. ¿Qué necesitas hacer?',
        'Enviamos técnico en el día si hay disponibilidad. ¿Es urgente? 🔨'
      ]
    };
    const times = catTime[cat] || [
      'Depende del servicio que necesites. ¿Nos das más detalles? ⏱️',
      'Trabajamos rápido y con calidad. ¿Cuál es tu urgencia? 😊',
      'Hacemos lo posible para atenderte lo antes posible. ¿Qué necesitas? ⚡'
    ];
    return _pick(times);
  }

  // ── Contacto / teléfono / WhatsApp ──
  if (/\b(teléfono|telefono|número|numero|whatsapp|llamar|contacto|escribir)\b/.test(t)) {
    const phone = biz && biz.phone ? biz.phone : 'disponible en nuestro perfil';
    return _pick([
      `Puedes llamarnos al ${phone} 📞. También atendemos por aquí en Fynder.`,
      `Nuestro número es ${phone}. ¿Prefieres que te contactemos nosotros? 📲`,
      `¡Puedes contactarnos aquí mismo! Si prefieres llamar, el número es ${phone} ☎️`
    ]);
  }

  // ── Quejas / problemas / mal servicio ──
  if (/\b(queja|problema|mal|fallo|defecto|molest|inconveniente|reclamo|devolución|reembolso)\b/.test(t)) {
    return _pick([
      'Lamentamos mucho lo ocurrido 😔. Tu satisfacción es lo más importante para nosotros. ¿Nos cuentas qué pasó?',
      'Disculpa el inconveniente. Queremos resolverlo lo antes posible. ¿Puedes darnos más detalles?',
      'Entendemos tu frustración y lo tomamos muy en serio 🙏. ¿Cómo podemos compensarte?',
      'Gracias por avisarnos. Vamos a revisar tu caso de inmediato. ¿Tienes el número de pedido o fecha de servicio?'
    ]);
  }

  // ── Agradecimiento ──
  if (/\b(gracias|thank|perfecto|excelente|genial|increíble|muy bien|buenísimo|satisfecho)\b/.test(t)) {
    return _pick([
      '¡A ti por preferirnos! 🙏 Fue un placer atenderte. ¡Hasta pronto!',
      '¡Gracias a ti! 😊 Que tengas un excelente día. Vuelve cuando quieras.',
      '¡De nada! Tu satisfacción es nuestra prioridad ⭐. ¡Hasta la próxima!',
      'Es un honor servirte. ¡Recuerda que siempre estamos aquí para ti! 💚'
    ]);
  }

  // ── Disponibilidad / stock ──
  if (/\b(disponible|disponibilidad|hay|tienen|stock|existe|queda|quedan)\b/.test(t)) {
    return _pick([
      '¡Sí tenemos disponibilidad! ✅ ¿Para qué fecha o cantidad lo necesitas?',
      'Déjame verificar el stock. ¿Me dices exactamente qué buscas? 🔍',
      'Sí contamos con eso. ¿Quieres apartar o hacer el pedido ahora? 📦',
      'Tenemos en stock. ¿Cuánto necesitas y para cuándo? 😊'
    ]);
  }

  // ── Redes sociales / Instagram ──
  if (/\b(instagram|facebook|redes|social|seguir|perfil|página|tiktok)\b/.test(t)) {
    const ig = biz && biz.instagram ? biz.instagram : '@' + bizName.toLowerCase().replace(/\s/g,'_');
    return _pick([
      `¡Síguenos en Instagram como ${ig}! 📸 Publicamos novedades y promos todos los días.`,
      `Estamos en Instagram y Facebook. Allí subimos fotos de nuestros trabajos y promociones 🔥`,
      `Encuéntranos en redes como ${ig}. ¡Dale follow para no perderte nada! ⭐`
    ]);
  }

  // ── Respuestas por categoría (cuando no hay keyword específica) ──
  const catReplies = {
    restaurantes: [
      '¡Con gusto te atendemos! 🍽️ ¿Buscas mesa para hoy, pedido para llevar o delivery?',
      '¿Tienes alguna preferencia de comida? Podemos recomendarte los platos favoritos de nuestros clientes 😋',
      'Hoy tenemos especiales del día. ¿Quieres que te los cuente? 🌟',
      '¿Es para celebrar algo especial? Podemos preparar algo personalizado para ti 🎂',
      'Tenemos sección vegetariana y opciones sin gluten. ¿Tienes alguna restricción alimentaria? 🥗'
    ],
    belleza: [
      '¡Bienvenida/o! 💇 ¿Vienes por primera vez? Te recomendamos empezar con una consulta gratuita.',
      '¿Buscas un cambio de look o mantenimiento? Cuéntanos tu idea y la hacemos realidad ✨',
      'Nuestras estilistas tienen más de 5 años de experiencia. ¡Estás en buenas manos! 💅',
      '¿Has visto algo en Instagram que te gustó? Tráenos la foto y lo recreamos 📸',
      'Trabajamos con productos profesionales libres de parabenos y sulfatos 🌿. ¿Te importa eso?'
    ],
    salud: [
      '¡Hola! 🏥 ¿Es para consulta, examen o tratamiento? Dinos para orientarte mejor.',
      'Recuerda traer tu carnet de seguro y resultados previos si los tienes 📋',
      'Nuestros médicos están certificados y con amplia experiencia. ¡Estás en buenas manos! 🩺',
      '¿Es una emergencia o consulta programada? Te orientamos según tu caso 🚑',
      'También hacemos consultas de seguimiento. ¿Ya fuiste atendido antes con nosotros? 📅'
    ],
    tecnologia: [
      '¡Hola techie! 💻 ¿Qué equipo necesitas reparar o qué servicio buscas?',
      'Hacemos diagnóstico gratuito. ¿Nos traes el equipo o prefieres que vayamos a verte? 🔧',
      '¿El problema es de hardware o software? Así te orientamos mejor ⚙️',
      '¿Cayó al agua, pantalla rota o no enciende? Cuéntanos los síntomas 📱',
      'También vendemos repuestos originales y accesorios. ¿Necesitas algo específico?'
    ],
    hogar: [
      '¡Hola! 🏠 ¿Qué trabajo necesitas hacer en tu hogar? Estamos para ayudarte.',
      'Trabajamos en plomería, electricidad, pintura y remodelaciones. ¿Qué necesitas? 🔨',
      '¿Es urgente o puedes programarlo? Tenemos técnicos disponibles hoy 🛠️',
      'Enviamos presupuesto sin costo. ¿Nos describes el trabajo o mandamos a un técnico a evaluar? 📋',
      'Todos nuestros técnicos están certificados y asegurados. ¡Trabaja con confianza! ✅'
    ],
    turismo: [
      '¡Hola viajero! ✈️ ¿Buscas tours locales, paquetes o experiencias especiales?',
      '¿Para cuántas personas y en qué fecha planeas tu aventura? 🗓️',
      'Tenemos tours para todos los gustos: aventura, cultura, naturaleza y gastronomía 🌍',
      '¿Ya conoces el lugar o es tu primera visita? Así personalizamos mejor tu experiencia 🗺️',
      'Nuestros guías son bilingües y conocen cada rincón. ¡Serás en buenas manos! 🧭'
    ],
    transporte: [
      '¡Hola! 🚗 ¿Para qué fecha y destino necesitas el servicio?',
      '¿Es un traslado al aeropuerto, tour o ruta específica? Cuéntanos 🛫',
      'Contamos con sedanes, SUVs y vans. ¿Cuántas personas son? 🚐',
      '¿Necesitas servicio frecuente o por evento? Tenemos tarifas especiales 💼',
      'Conductor puntual y vehículos en perfectas condiciones. ¡Tu seguridad es lo primero! 🛡️'
    ],
    ropa: [
      '¡Hola! 👗 ¿Buscas algo en especial: casual, formal, sport o para una ocasión específica?',
      '¿Cuál es tu talla? Así verificamos disponibilidad de lo que buscas 👕',
      'Acabamos de recibir nueva colección. ¿Quieres fotos de las novedades? 📸',
      '¿Es para regalo? Podemos envolvérselo bonito sin costo adicional 🎁',
      'Hacemos cambios y devoluciones en 15 días. ¡Compra con confianza! ✅'
    ],
    deportes: [
      '¡Hola atleta! 🏋️ ¿Qué deporte practicas o qué equipo necesitas?',
      'Tenemos marcas originales con garantía. ¿Buscas algo específico? ⚽',
      '¿Eres principiante o ya tienes experiencia? Así te recomendamos mejor el equipo 🎽',
      'También tenemos ropa deportiva y suplementos. ¿Necesitas algo de eso? 💪',
      'Medimos tu pisada gratis para recomendarte el calzado correcto 👟'
    ]
  };

  const catArr = catReplies[cat] || [
    `¡Gracias por escribir a ${bizName}! 😊 ¿En qué podemos ayudarte hoy?`,
    'Recibimos tu mensaje. ¿Puedes contarnos más sobre lo que necesitas? 🙏',
    '¡Con gusto te atendemos! ¿Qué servicio o producto estás buscando?',
    'Estamos aquí para ayudarte. ¿Cuéntanos qué necesitas? ✅',
    'Gracias por contactarnos. ¡Dinos cómo podemos servirte! 🌟'
  ];
